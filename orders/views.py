...
from marketplace.contextProcessors import get_cart_amounts
...
def placeOrder(request):
    ...
    # calculate individual vendor's subtotal
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render(request, 'orders/placeOrder.html', context=context)
...
def payments(request):
    if request.headers.get('x-requested-with') == 'XMLHttpRequest' and request.method == "POST":
        ...
        mail_subject = "Your Order is Placed.Thank you for Ordering with us."
        ...
        mail_subject = "Your Have received a New Order."
        ...
        for i in cart_items:
            if i.fooditem.vendor.user.email not in to_emails:
                ...
                context = {
                    ...
                    'vendor_grandtotal' : order_total_by_vendor(order, i.fooditem.vendor.id)['grand_total'],
                }
                send_notification(mail_subject,mail_template,context)
...
def orderComplete(request):
    ...
    try:
        ...
        return render(request, 'orders/orderComplete.html',context=context)
